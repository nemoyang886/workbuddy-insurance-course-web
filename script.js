(function(){
  ...
  const promptMeta = {
    ...
    21:["写入 Agent.md 员工手册","替换成自己的展业定位和资料规则","一份 Agent.md 工作规则"],
    22:["写入表达、合规与交付流程","保留合规边界，替换个人表达要求","Agent.md 下半部分"],
    24:["生成个人表达风格说明书","读取 SOUL.md、Agent.md 和样本","后续朋友圈可调用的风格说明书"],
  ...
  const outputLabelMap = {
    ...
    17:"本页产出：一张六格任务卡",
    18:"本页产出：一段通用任务模板",
    20:"本页产出：理解 SOUL.md 和 Agent.md 的长期记忆作用",
    21:"本页产出：一份 Agent.md 员工手册",
  ...
  const routeTakeaways = [
    ["个人画像", "真实问题", "一句业务需求"],
    ["任务入口", "SOUL/Agent", "Ask Plan Craft"],
    ["朋友圈文案", "定联方案", "课堂产物"],
    ["满意样本", "Skill V1", "3天跟进"]
  ];
